...
import fixPersonsList from '../lib/common/fixPersonsList';
import fixSeriesList from '../lib/common/fixSeriesList';
import getFixedBooksFromFs from '../lib/common/getFixedBooksFromFs';
import readConfig from '../lib/common/readConfig';
import updateBookInfo from '../lib/common/updateBookInfo';
import writeConfig from '../lib/common/writeConfig';
